...
class FlashcardToGradeDispatcherStub(object):
    """Missing associated documentation comment in .proto file."""
...
class FlashcardToGradeDispatcherServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_FlashcardToGradeDispatcherServicer_to_server(servicer, server):
 ...
 # This class is part of an EXPERIMENTAL API.
class FlashcardToGradeDispatcher(object):
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def DispatchFlashcardToGrade(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
